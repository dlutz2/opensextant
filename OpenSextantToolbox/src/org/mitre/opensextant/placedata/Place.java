...
/**
 * A Place represents a named geographic location, a "place". It contains basic
 * information about that place, such as its name, its geographic location, the
 * country it is part of or located in, what type of place it is (e.g. city,
 * river, province) and the original source of this information. These reflect
 * the data traditionally found in gazetteers.
 */
public class Place implements Comparable<Object>, Serializable {
	...
	/**
	 * Set and get Geohash -- this is delegated to caller as core processing
	 * need not have a geohash generated when lat/lon is set.
	 */
