...
public class PhoneticUtils {
   ...
   * such as Mr.Pibbs incorrectly becomes MrPibbs but for the purposes of normalizing tokens this should be fine. Use
   * appropriate tokenization prior to using this as a filter.
   */
