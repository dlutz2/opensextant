...
public class SolrProxy {
	 ...
	 * @throws IOException
	 */
	public SolrProxy(String solr_home, String core, boolean noSerialize)
	  throws IOException {
		this.server_url = null;
	...
	public final void setupCore(String solr_home, String corename,
			boolean serializationMode) throws IOException {
		this.solrServer = SolrProxy.initialize_embedded(solr_home, corename,
				serializationMode);
	}
	/**
     *
     */
	public static SolrServer initialize_embedded(String solr_home,
			String corename, boolean avoidSerialization) throws IOException {
		try {
