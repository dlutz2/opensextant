...
/**
 * This GATE ProcessingResource implements a tagger which adds a "phonetically"
 * reduced string to tokens as a feature. The nature/form of that reduction is
 * determined by the algorithm selected via the <code>setPhoneticAlgo()</code>
 * method. These algorithms include case removal, diacritic stripping,
 * punctuation removal and others. For all available algorithms see
 * org.mitre.opensextant.phonetic.Phoneticizer.
 *
 */
...
public class PhoneticTaggerPR extends AbstractLanguageAnalyser implements
	...
	String stringFeatureName; // the existing feature on tokenAnnoType containg
								// the word
	...
	public void execute() throws ExecutionException {
		...
		AnnotationSet annotSet = (outputASName == null || outputASName
