 ...
 * The nature/form of that reduction is determined by the algorithm selected via the <code>setPhoneticAlgo()</code>
 * method. These algorithms include case removal, diacritic stripping, punctuation removal and others. For all available
 * algorithms see org.mitre.opensextant.phonetic.Phoneticizer. *
 */
@SuppressWarnings("serial")
@CreoleResource(name = "OpenSextant PhoneticTagger", comment = "Tags tokens with a phonetic or reduced form")
public class PhoneticTaggerPR extends AbstractLanguageAnalyser implements ProcessingResource {
