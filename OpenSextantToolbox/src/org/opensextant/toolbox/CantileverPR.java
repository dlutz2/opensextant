...
public class CantileverPR extends AbstractLanguageAnalyser implements ProcessingResource {
  ...
  /**
   * This does the actual work of analyzing the evidence attached to the place candidates. It invokes Cantilever's
   * <code>propagateEvidence()</code> for the place candidates found in each document.
   *
