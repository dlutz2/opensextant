...
/**
 * A PlaceCandidate represents a portion of a document which has been identified as a possible named geographic
 * location. It is used to collect together the information from the document (the evidence), as well as the possible
 * geographic locations it could represent (the Places ). It also contains the results of the final decision to include:
 * <ul>
 * <li>placeConfidenceScore - Confidence that this is actually a place and not a person, organization, or other type of
 * entity.
...
public class PlaceCandidate implements Serializable {
  ...
  /**
   * TextEntity.getText() the actual text is the place name attr Not to be confused with the place names of candidate
   * places enumerated under getPlaces()
   */
  ...
  /**
   * Get the PlaceConfidence score. This is the confidence that this PlaceCandidate represents a named place and not a
  ...
  /**
   * Set the PlaceConfidence score to a specific value. NOTE: This method is only intended to be used in
   * calibration/testing, it would not normally be used in production.Note that it removes any existing rules and
   * confidences.
   */
