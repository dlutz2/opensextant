 	...
 	the publicly available gazetteer data into a clean consistent form suitable ready to be used by the OpenSextant geotagger.
 	...
 	3) do the build: ant
 	 ...
 	 subdirectories of Gazetteer/GazetteerETL/GeoData/. It will then run the Kettle script (BuildMergedGazetteer.kjb) which will in clean, transform 
